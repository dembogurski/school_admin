...
/*Table structure for table `adm_param` */

DROP TABLE IF EXISTS `adm_param`;

CREATE TABLE `adm_param` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `p_ref` varchar(10) DEFAULT NULL,
  `p_ejercicio` varchar(4) DEFAULT NULL,
  `p_desc_1` int(11) DEFAULT NULL,
  `p_desc_2` int(11) DEFAULT NULL,
  `p_desc_3` int(11) DEFAULT NULL,
  `p_desc_4` int(11) DEFAULT NULL,
  `p_desc_5` int(11) DEFAULT NULL,
  `p_desc_6` int(11) DEFAULT NULL,
  `p_desc_7` int(11) DEFAULT NULL,
  `p_margen` double(4,2) DEFAULT NULL,
  `p_ruc_emp` varchar(14) DEFAULT NULL,
  `p_iva` double(4,1) DEFAULT NULL,
  `par_pgto_chq` varchar(5) DEFAULT NULL,
  `p_cod_tesoreria` varchar(60) DEFAULT NULL,
  `p_limit` int(11) DEFAULT NULL,
  `etiq_font_size` int(11) DEFAULT NULL,
  `etiq_izq_space` int(11) DEFAULT NULL,
  `etiq_dist` int(11) DEFAULT NULL,
  `etiq_ancho` int(11) DEFAULT NULL,
  `etiq_alto` int(11) DEFAULT NULL,
  UNIQUE KEY `id` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Table structure for table `par_parametros` */

DROP TABLE IF EXISTS `par_parametros`;

CREATE TABLE `par_parametros` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `par_cj_neg` varchar(2) DEFAULT NULL,
  `p_suc` varchar(8) DEFAULT NULL,
  `p_user` varchar(60) DEFAULT NULL,
  `p_top` int(11) DEFAULT NULL,
  `p_left` int(11) DEFAULT NULL,
  `p_right` int(11) DEFAULT NULL,
  `p_bottom` int(11) DEFAULT NULL,
  `p_medium` int(11) DEFAULT NULL,
  UNIQUE KEY `id` (`id`)
