...
$Obj->Sort = "id desc";
$Obj->p_insert = "";
$Obj->p_change = "'select transf_pieza('+codigo_de.getVal()+','+codigo_a.getVal()+','+cantidad.getVal()+','+cantidad.getVal()+')'";
$Obj->p_delete = "";
