<?php
$Obj->name = "reservas_x_suc";
$Obj->alias = "Reservas por Sucursal (Pendientes + Insertar)";
$Obj->help = "Reservas por Sucursal (Pendientes + Nuevo)";
$Obj->copy_from = "";
$Obj->Inheritance = "";
$Obj->File = "temp";
$Obj->Filter = "";
...
$Obj->Add(
    array(
        ...
        F_HELP_ => "Reservas",
        F_TYPE_ => "subform",
        F_OPTIONS_ => "'__local = '+__local.getStr()+' and estado = |{En Caja}| '",
        F_LINK_ => "db.reservas_caja",
        F_SEND_ => "__user.get()",
        F_NODB_ => "1",
        F_ORD_ => "20",
        G_SHOW_ => "64",
