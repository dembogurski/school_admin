<?php
$Obj->name = "reservas_pen";
$Obj->alias = "Reservas de Telas Pendientes de Retiro";
$Obj->help = "Reservas de Telas Pendientes de Retiro";
$Obj->copy_from = "";
$Obj->Inheritance = "";
$Obj->File = "reservas";
$Obj->Filter = "";
...
$Obj->Add(
    array(
        F_NAME_ => "cobrar",
        F_ALIAS_ => "Liberar la reserva para Venta",
        F_TYPE_ => "select_list",
        F_OPTIONS_ => "No,Si",
        F_NODB_ => "1",
        F_ORD_ => "560",
...
$Obj->Add(
    array(
        ...
        F_ALIAS_ => "Liberar esta Reserva para Venta",
        F_HELP_ => "Libera  esta Reserva para Venta",
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'select liberar_reserva('+nro_res.getVal()+','+__local.getStr()+')'",
...
$Obj->Add(
    array(
        F_NAME_ => "r_vencida",
        F_ALIAS_ => "Marcar esta Reserva como Vencida",
        F_HELP_ => "Marcar esta Reserva como Vencida",
        F_TYPE_ => "proc",
        F_QUERY_ => "'UPDATE  reservas r, reserva_det d, mnt_prod p SET r.estado = |{Vencida}|,p.prod_fin_pieza = |{No}|  WHERE r.nro_res = d.nro_res AND d.codigo = p.p_cod AND r.nro_res =  '+nro_res.getVal()+' AND r.estado = |{Pendiente}|'",
        F_NODB_ => "1",
        F_ORD_ => "590",
        C_SHOW_ => "operation==CHANGE_",
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "600",
        F_INLINE_ => "1",
        C_SHOW_ => "cobrar_reserva.getVal()>0||r_vencida.get()",
        C_VIEW_ => "false",
