<?php
$Obj->name = "mis_presupuestos";
$Obj->alias = "Mis Presupuestos";
$Obj->help = "Mis Presupuestos";
$Obj->copy_from = "";
$Obj->Inheritance = "";
$Obj->File = "temp";
$Obj->Filter = "";
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "subform",
        F_OPTIONS_ => "'mnt_cli.cli_ci=fact_cli_ci and mnt_cli.cli_cat = fact_cli_cat AND fact_empaque=|{No}| and fact_estado=|{Presup}| and fact_localidad = '+__local.getStr()+' and fact_vend_cod =|{'+p_user_+'}| '",
