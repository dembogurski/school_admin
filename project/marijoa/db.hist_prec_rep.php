<?php
$Obj->name = "hist_prec_rep";
$Obj->alias = "Reporte de Modificacion de Precios";
$Obj->help = "Reporte de Modificacion de Precios";
$Obj->copy_from = "";
$Obj->Inheritance = "";
$Obj->File = "temp";
$Obj->Filter = "";
...
$Obj->Add(
    array(
        ...
        F_FILTER_ => "'true order by codigo asc'",
        F_ORD_ => "40",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
...
$Obj->Add(
    array(
        F_NAME_ => "__rep",
        F_ALIAS_ => "Generar Reporte de Modificacion de Precios",
        F_HELP_ => "Generar Reporte",
        F_TYPE_ => "report",
        F_REPORT_ => "rep.hist_precios",
        F_NODB_ => "1",
        F_ORD_ => "90",
