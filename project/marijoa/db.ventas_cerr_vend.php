<?php
$Obj->name = "mis_ventas_cerr";
$Obj->alias = "Mis Ventas Cerradas";
$Obj->help = "Mis Ventas Cerradas";
$Obj->copy_from = "";
$Obj->Inheritance = "";
$Obj->File = "temp";
$Obj->Filter = "";
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "subform",
        F_OPTIONS_ => "'mnt_cli.cli_ci=fact_cli_ci and mnt_cli.cli_cat = fact_cli_cat AND fact_estado=|{Cerrada}| and fact_localidad = '+__local.getStr()+' and fact_vend_cod =|{'+p_user_+'}| and fact_fecha like '+fechahoy.getStr()+''",
        F_LINK_ => "db.venta_no_edit",
        F_SEND_ => "''",
        F_NODB_ => "1",
        F_ORD_ => "10",
        G_SHOW_ => "64",
