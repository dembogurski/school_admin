...
$Obj->Add(
    array(
        ...
        F_HELP_ => "Estado",
        F_TYPE_ => "select_list",
        F_OPTIONS_ => "Abierta,Pendiente,En Proceso,Cerrada",
        F_BROW_ => "1",
        F_ORD_ => "200",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
...
$Obj->Add(
    array(
        F_NAME_ => "__printcheck",
        F_ALIAS_ => "Verificar Estado de Piezas antes del Envío",
        F_HELP_ => "Verificar Estado de Piezas antes del Envío",
        F_TYPE_ => "report",
        F_REPORT_ => "rep.pedido_check",
        F_NODB_ => "1",
        F_ORD_ => "205",
        F_INLINE_ => "1",
        G_SHOW_ => "64",
