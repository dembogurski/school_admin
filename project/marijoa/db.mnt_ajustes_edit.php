<?php
$Obj->name = "mnt_ajustes_edit";
$Obj->alias = "Edicion de Ajustes";
...
$Obj->p_insert = "";
$Obj->p_change = "";
$Obj->p_delete = "'select makeLog_(|{BORRAR}|,|{Codigo Nro: '+aj_prod.get()+' Fecha ORG :  '+aj_fecha.get()+'}|,|{'+p_user_+'}|)'";
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "100",
        C_VIEW_ => "true",
        F_FORMULA_ => "'Puede que necesite ajustar el Stock del producto!!!'",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
...
$Obj->Add(
    array(
        ...
        C_SHOW_ => "true",
        C_VIEW_ => "false",
        F_FORMULA_ => "document.getElementById(|{msg}|).setAttribute(|{style}|,|{height:28px;color:green;font-size:14px;}|) ",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
...
$Obj->Add(
    array(
        ...
        C_VIEW_ => "false",
        F_FORMULA_ => "if( p_user_!='Jack'&&p_user_!='Developer'&&p_user_!='elisa' ){disableDeleteButton()}",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
?>
