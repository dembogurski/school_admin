...
$Obj->Add(
    array(
        F_NAME_ => "fecha",
        F_ALIAS_ => "Fecha",
        F_HELP_ => "Fecha (En este mes se le otorgara en su haber)",
        F_TYPE_ => "date",
        F_OPTIONS_ => "20",
        F_LENGTH_ => "10",
        F_BROW_ => "1",
...
$Obj->Add(
    array(
        ...
        F_FILTER_ => "'func_fullname LIKE |{'+busc_func.get()+'%}| or func_cod  LIKE |{'+busc_func.get()+'%}|  ORDER BY func_cod LIMIT 20'",
        F_BROW_ => "1",
        F_REQUIRED_ => "1",
        F_ORD_ => "20",
        F_INLINE_ => "1",
...
$Obj->Add(
    array(
        ...
        F_HELP_ => "Motivo",
        F_TYPE_ => "select_list",
        F_OPTIONS_ => "Variable o Premio,Aguinaldo,Reembolso,Vacaciones,Feriado",
        F_ORD_ => "45",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
