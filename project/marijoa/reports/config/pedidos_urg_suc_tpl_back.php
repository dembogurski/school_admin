...
<!-- begin: start_query0 -->
    ...
    <table style="text-align: left; width: 100%;" border="1"cellpadding="0" cellspacing="0" id="tabla">
        ...
        <thead>
            ...
            <tr> <td colspan="2" align="center"> Estado de los Codigos
                    ...
                    <input type="text" size="10" class="" value="Suspendido" style="text-align:center;background: red"> &nbsp; <b>Tipo Filtro</b> {mayorista}


                </td>

                <td> <b>Pedidos desde:   {sup_origen}  &nbsp; <big> <big>  <big>   &rarr;   </big>  </big> </big>  &nbsp; {sup_destino} &nbsp; &nbsp; &nbsp; <i>(Douglas)</i>&#8482; </b> </td></tr>
            </tbody>
    </table><hr />
</td></tr>
<!-- end:   start_query0 -->
...
<tr>
    ...
    <th>FECHA</th>
    <th>USURIO</th>
    <th><img src="images/ok.png" border="0"></th>
    <th>CODIGO</th>
    <th>REMP</th>

    <th>GRUPO &nbsp;-&nbsp; TIPO &nbsp;-&nbsp; COLOR  &nbsp;-&nbsp; DESCRIPCION</th>
    <th style="text-align: right;">CANT</th>
    <th>URGE</th> <!-- <th>EST.NOTA</th> --><th>EST.COD</th>
...
<tr class="pendiente">
    <td rowspan="2">{query0_NRO}</td>
    <td rowspan="2" style="text-align: center" >{query0_ORIGEN}<label >   &rarr;   </label>  {query0_DESTINO}</td>
    <td rowspan="2">{query0_FECHA}</td>
    <td rowspan="2">{query0_USURIO}</td>
    <td rowspan="2"><input type="checkbox" id="check_{query0_CODIGO}" value="{query0_CODIGO}" unchecked  onchange="setIcon({query0_CODIGO},{query0_NRO})" ><span id="icon_check_{query0_CODIGO}"></span>  </td>
    <td rowspan="2" id="{query0_CODIGO}" name="codigo_{query0_CODIGO}" align="center" ><a style="text-decoration:none" href=javascript:verOpciones("{fecha_inv}","{query0_CODIGO}","{query0_CANTIDAD}","{suc}") >{query0_CODIGO}</a> </td>
    <td rowspan="2" align="center" width="90px"><input type="text" id="cod_rem_{query0_CODIGO}"  value="{query0_REM}" class="textfield"  size="8" onchange=remplazar("{query0_CODIGO}","{query0_NRO}")    ></td>
    <td id="descrip_{query0_CODIGO}">{query0_GRUPO}&nbsp;-&nbsp;{query0_TIPO}&nbsp;-&nbsp;{query0_COLOR}&nbsp;-&nbsp;{query0_DESCRIP}</td>
    <td style="text-align: right;" id="cant_{query0_CODIGO}">{query0_CANTIDAD}</td>
...
<tr> <td colspan="5">{query0_OBS}</td></tr>
{opciones}
<!-- end:    query0_data_row -->
...
<tr>
    ...
    <td> <input type="checkbox" id="puntear" onchange="puntear()"  > </td>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
