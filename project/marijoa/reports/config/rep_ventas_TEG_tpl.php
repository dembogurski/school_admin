	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td style="text-align: center;"><big
			style="font-weight: bold;"><big>Reporte de Ventas Temporada Estructura Grupo   &nbsp; {desde}&nbsp;--&nbsp;{hasta}&nbsp; &nbsp; &nbsp;[{sup_rep_localidad}] </big></td>
		  <td style="text-align: right;">
...
<!-- begin: query0_data_row -->
        <div class="block"><tr>
            ...
            <td><small>{query0_ESTRUCTURA}</small></td>
