<!-- 
    Report Template File (facts_reabiert)
	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td style="text-align: center;"><big
			style="font-weight: bold;"><big>Facturas Re Editadas ({sup_suc}) <br/> Per&iacute;odo: {fecha}</big></td>
		  <td style="text-align: right;">
...
<!-- begin: query0_data_row -->
       <tr>
           <td class="item">{nro}</td>
            ...
            <td class="itemc"> {query0_fact_estado}</td>
         </tr>
<!-- end:    query0_data_row -->
