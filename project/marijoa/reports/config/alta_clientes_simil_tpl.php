    ...
    <script lang="javascript">
        ...
        function verSimilares(id,ruc){
            ...
            if(img == "images/left.png"){
              ...
              $("#img_"+id+"").fadeOut(4000);
              
              $("#tr_"+id+"").html("");
              $("#tr_"+id+"").slideUp("slow");
              $("#tr_"+id+"").css("height","3px");
              
              
              /*$("#tr_"+id).slideToggle(function(){
                   alert(1); 
              });*/
...
<!-- begin: query0_data_row -->
         <tr class="{zebra}">            
            <td id="ruc_{id}">&nbsp;{query0_CI_RUC} &nbsp;&nbsp;<a href=javascript:verSimilares("{id}","{query0_CI_RUC}")><img border="0" src="images/down.png" id="img_{id}" /> </a>   </td>
