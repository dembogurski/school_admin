...
/** Report prg file (imp_chq_bco_con) 
 *  
...
$T->Set( 'sup_cta_bco', '2');
$T->Set( 'sup_serie', 'D-');
$T->Set( 'sup_nro_ini', '258349');
$T->Set( 'sup_nro_fin', '258350');
$T->Set( 'sup_ini', 'D-258349');
$T->Set( 'sup_final', 'D-258350');
$T->Set( 'sup_cheques', '');
$T->Set( 'sup_imprimir', '');
...
//$query0 = "SELECT chq_cta, chq_num, chq_estado, chq_fecha_emis, chq_fecha_pag, chq_valor, chq_benef, chq_bco, chq_moneda  FROM bcos_chq WHERE   chq_num >= 'D-258349' and chq_num <= 'D-258350' and chq_estado = "Emitido" and chq_bco = '2'";
...
while( $Q0->NextRecord() ){
    ...
    $T->Set('letras', substr($cadena,0,strlen($cadena)-9).' DOLARES');  
