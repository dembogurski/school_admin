	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td style="text-align: center;"><big
			style="font-weight: bold;"><big>Reporte de Compras del periodo {data_ini} al {data_fin} &nbsp; &nbsp;[{sup_rep_localidad}]</big></td>
		  <td style="text-align: right;">
...
<!-- begin: header0 -->
    <tr>
        ...
        <th style="text-align: right;">VALOR G$</th>
    </tr>
</thead>
<tfoot>
...
<!-- begin: query0_data_row -->
        <div class="block"><tr>
            ...
            <td style="text-align: right;">{query0_VALORUS}</td>
...
<!-- begin: query0_subtotal_row -->
	 ...
	 <td style="text-align: right;"><b>{subtotal0_VALORUS}</b></td>
            <td style="text-align: right;"><b>{subtotal0_VALOR}</b></td>
        </tr>
        <tr>
            <td colspan='6' align="right"  ><b>Ref:  </td>
	    <td  style="text-align: right;"  ><b>{dif}</td>
        </tr>	 
