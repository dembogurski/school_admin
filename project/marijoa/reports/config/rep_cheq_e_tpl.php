	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td style="text-align: center;"><big
			style="font-weight: bold;"><big>Cheques  &nbsp; desde: &nbsp; {desde}&nbsp; hasta: {hasta} &nbsp; &nbsp; Cuenta: {cuenta}</big></td>
		  <td style="text-align: right;">
...
<!-- begin: header0 -->
    <tr>
        ...
        <th style="text-align: center;"> FECHA_PAGO</th>  <th> &nbsp;Nro</th>
...
<!-- begin: query0_data_row -->
        <div class="block"><tr>
            ...
            <td  style="text-align: center;">{query0_FECHA_PAGO}</td> <td> &nbsp;{query0_Nro}</td>
            <td style="text-align: right;">{query0_VALOR} &nbsp;</td>
            <td>&nbsp;&nbsp;{query0_BENEFICIARIO}</td>
