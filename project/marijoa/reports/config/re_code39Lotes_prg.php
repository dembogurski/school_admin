...
$query0 = "select p_cod as CODIGO_BARRAS, p_local as LOCALIDAD,p_fam, p_grupo,p_tipo,p_comp,p_temp,p_estruc,p_clasif,p_color,p_cant,p_precio_1,p_descri, p_ancho, p_ref as REF  from mnt_prod where p_cod =  $codigos ";
