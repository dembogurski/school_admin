...
//$query0 = "SELECT a.nro_as AS NRO, DATE_FORMAT(a.fecha,"%d-%m-%Y")  AS FECHA,d.codigo AS REF, p.c_descrip AS DESCRIPCION, d.debe AS DEBE, d.haber AS HABER FROM asientos_cont a, asientos_det d, plan_cuentas p WHERE a.nro_as = d.nro_as AND d.codigo = p.c_cod AND a.nro_as = '7'  ORDER BY  a.fecha ASC, a.nro_as ASC ";
...
$endConsult = true;
if( $endConsult ){
    if($subtotal0_DEBE != $subtotal0_HABER ){
      $T->Set('fondo', 'red;');   
    }else{
      $T->Set('fondo', 'white;');    
    }
