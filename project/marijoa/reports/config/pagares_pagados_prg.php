...
/** Report prg file (pagares_pagados) 
 *  
...
// Superior Variables
$T->Set( 'sup_busc_prov', 'para');
$T->Set( 'sup_prov', '1');
$T->Set( 'sup_prov_nombre', 'PARAGUAY TEXTIL');
$T->Set( 'sup_desde', '2008-01-01');
$T->Set( 'sup_hasta', '2009-12-14');
$T->Set( 'sup_rep', '');
$T->Set( 'sup_repp', '');
...
//$query0 = "select id as ID, pg_nro as Nro, DATE_FORMAT(pg_fecha ,"%d-%m-%Y")   as VENCIMIENTO, pg_benef as PROVEEDOR, pg_monto as MONTO, pg_estado as ESTADO, detalle as DETALLE  from pagares_propios where pg_fecha between '2008-01-01' and '2009-12-14' and pg_benef like 'PARAGUAY TEXTIL'";
