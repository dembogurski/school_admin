...
while ($Q0->NextRecord()) {
    ...
    // Crear una vista
    $dbc->Query("select distinct p_color from mnt_prod where p_fam = '$sector'  AND p_grupo = '$grupo'  AND p_tipo = '$tipo' AND prod_fin_pieza != 'Si' AND p_local != '11' and p_cant > 0");
