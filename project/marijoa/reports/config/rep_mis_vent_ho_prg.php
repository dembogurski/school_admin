...
/** Report prg file (rep_mis_vent_ho) 
 *  
...
$T->Set( 'sup_desde', '2008-07-01');
$T->Set( 'sup_hasta', '2008-07-04');
$T->Set( 'sup_gen', '');
$T->Set( 'sup_rep_hoy', ''); */
// ------------------------------------------

// THIS IS YOUR FIRST QUERY:
//$query0 = "select fact_nro as Nro, fact_nom_cli as CLIENTE, fact_comi_vend AS COMISION, fact_total as TOTAL from factura where fact_vend_cod =  'graciela' and fact_fecha = current_date and fact_estado = "Cerrada" ";
