...
$mostrar_precio = $sup['mostrar_precio'];
if($mostrar_precio == '' || $mostrar_precio == 'Si' ){
   $T->Set( 'Precio', 'Precio' ); 
   $T->Set( 'moneda', 'Gs' ); 
}else{
   $T->Set( 'Precio', '' );   
...
while( $Q0->NextRecord() ){
    ...
    $codigo_barras = substr( "00000000".$el['CODIGO_BARRAS'],-13);
    $T->Set( 'codigo',$codigo_barras );	 
    ...
    $cod_cliente = $filename->parseCode($cod_cli);    
    ...
    $T->Set('query0_CODIGO_BARRAS_CLI', $cod_cliente);
    ...
    $combinado =  $el['p_grupo'].'-'.$el['p_color'].'-'.$descrip.'_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _';
