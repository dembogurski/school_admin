	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td style="text-align: center;"><big
                      style="font-weight: bold;"><big>Previsualizaci&oacute;n de Asiento</big></td>
		  <td style="text-align: right;">
...
<tr style="background:{fondo}">
            ...
            <td class="izq">&nbsp;</td>
            <td class="izq">&nbsp;</td>
            <td class="izq" style="text-align: right;font-size: 14px"><b>{subtotal0_DEBE}</b></td>
            <td class="der" style="text-align: right; right;font-size: 14px"><b>{subtotal0_HABER}</b></td>
        </tr>
