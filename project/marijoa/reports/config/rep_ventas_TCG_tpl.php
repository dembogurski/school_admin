	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td style="text-align: center;"><big
			style="font-weight: bold;"><big>Reporte de Ventas Temporada Clasificacion Grupo  {tipo}  &nbsp; {desde}&nbsp;--&nbsp;{hasta}&nbsp; &nbsp; &nbsp;[{sup_rep_localidad}] </big></td>
		  <td style="text-align: right;">
...
<!-- begin: query0_data_row -->
        <div class="block"><tr>
            <td><small>{query0_TEMPORADA}</small></td>
            <td><small>{query0_CLASIFICACION}</small></td>
...
<!-- begin: query0_subtotal_row2 -->
        <tr>
            <td>{query0_TEMPORADA}</td>
            <td>{query0_CLASIFICACION}</td>
            <td>{query0_GRUPO}</td>
            <td style="text-align: right;"><b>{subtotal0_CANT}</b></td>
            <td style="text-align: right;"><b>{subtotal0_SUBTOTAL}</b></td>
        </tr>
