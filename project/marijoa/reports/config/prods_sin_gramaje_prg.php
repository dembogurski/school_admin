...
/** Report prg file (prods_sin_gramaje) 
 *  
...
//$query0 = "SELECT p_cod,p_fam,p_grupo,p_tipo,p_color,p_cant,p_ancho,p_gram  FROM mnt_prod WHERE p_local = '07' AND p_gram IS NULL OR p_gram = 0 AND p_cant > 0 AND prod_fin_pieza <> "Si"  ORDER BY p_fam,p_grupo,p_tipo,p_color ";
