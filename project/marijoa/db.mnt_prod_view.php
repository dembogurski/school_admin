...
$Obj->p_change = "'update mnt_prod set p_fam = '+p_fam.getStr()+', p_grupo = '+p_grupo.getStr()+',p_tipo = '+p_tipo.getStr()+',p_color = '+p_color.getStr()+',p_comp = '+p_comp.getStr()+' , p_descri = '+p_descri.getStr()+', p_compra = '+p_compra.getVal()+', p_echo_en = '+p_echo_en.getStr()+', p_ancho = '+p_ancho.getVal()+' where p_padre = '+p_cod.getVal()+' '";
$Obj->p_delete = "";
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'select name from p_users p where name =|{'+p_user_+'}|'",
        F_QUERY_REF_ => "p_user.firstSQL&&operation==INSERT_",
...
$Obj->Add(
    array(
        ...
        F_NODB_ => "1",
        F_ORD_ => "160",
        C_SHOW_ => "(el['p_precio_1'].getVal()<el['p_valmin'].getVal())||(el['p_precio_2'].getVal()<el['p_valmin'].getVal())||(el['p_precio_3'].getVal()<el['p_valmin'].getVal())||(el['p_precio_4'].getVal()<el['p_valmin'].getVal())||(el['p_precio_5'].getVal()<el['p_valmin'].getVal())|| (el['p_precio_6'].getVal()<el['p_valmin'].getVal()) || (el['p_precio_7'].getVal()<el['p_valmin'].getVal())",
...
$Obj->Add(
    array(
        ...
        F_QUERY_REF_ => "p_kg.hasChanged()||p_cant.hasChanged()||p_ancho.hasChanged()",
        F_LENGTH_ => "12",
        F_DEC_ => "2",
        F_ORD_ => "225",
        F_INLINE_ => "1",
...
$Obj->Add(
    array(
        ...
        F_QUERY_REF_ => "p_echo_en.firstSQL&&operation==INSERT_",
        F_LENGTH_ => "35",
        F_REQUIRED_ => "1",
        F_ORD_ => "230",
        G_SHOW_ => "64",
...
$Obj->Add(
    array(
        F_NAME_ => "p_tara",
        F_ALIAS_ => "Peso de la Tara",
        F_HELP_ => "Peso de la Tara en Gramos",
        F_TYPE_ => "text",
        F_LENGTH_ => "12",
        F_DEC_ => "2",
        F_ORD_ => "420",
...
$Obj->Add(
    array(
        F_NAME_ => "p_gram_m",
        F_ALIAS_ => "Gramaje de Muestra",
        F_HELP_ => "Gramaje de Muestra",
        F_TYPE_ => "text",
        F_LENGTH_ => "12",
        F_DEC_ => "2",
        F_ORD_ => "420",
