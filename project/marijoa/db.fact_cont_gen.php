...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'SELECT  f_nro + 1 FROM fact_cont WHERE f_suc = '+f_suc.getStr()+' AND f_pdv = '+f_pdv.getStr()+' ORDER BY id DESC LIMIT 1 '",
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "48",
        F_INLINE_ => "1",
        F_FORMULA_ => "f_nro.getVal()+f_can.getVal()",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "180",
        C_SHOW_ => "!f_gen.get()",
        C_VIEW_ => "allValid&&operation==INSERT_&&f_check.getVal()<1",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
