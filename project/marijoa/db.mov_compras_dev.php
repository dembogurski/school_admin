...
$Obj->Add(
    array(
        ...
        F_SHOWFIELD_ => "p_cod,concat(p_fam,|{-}|, p_grupo,|{-}|, p_tipo,|{-}|, p_comp,|{-}|, p_temp,|{-}|)",
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'select p_cant from mnt_prod where p_cod = '+c_cod.getStr()",
        F_QUERY_REF_ => "c_cod.hasChanged()",
        F_LENGTH_ => "10",
        F_NODB_ => "1",
        F_ORD_ => "25",
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'select  DATE_FORMAT(c.c_fechafac,|{%d-%m-%Y}|), c_moneda, c_cambio  from mov_compras c where c_ref ='+c_ref.getStr()+' limit 1'",
        F_QUERY_REF_ => "c_ref.hasChanged()|| c_fechafac.firstSQL",
        F_ORD_ => "28",
        F_INLINE_ => "1",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
...
$Obj->Add(
    array(
        F_NAME_ => "c_fecha",
        F_ALIAS_ => "Fecha (Fecha del Mismo mes)",
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "50",
        F_INLINE_ => "1",
        F_FORMULA_ => "c_cant.getVal()*c_precio.getVal()",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "160",
        C_VIEW_ => "false",
        F_FORMULA_ => "if(p_user_!=|{Jorge}| && p_user_!=|{Developer}|){ disableChangeButton() }",
        G_SHOW_ => "64",
        G_CHANGE_ => "64"));
