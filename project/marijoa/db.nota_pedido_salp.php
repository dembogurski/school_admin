...
$Obj->alias = "Nota de Pedido Saliente Proveedores";
...
$Obj->Add(
    array(
        F_NAME_ => "estado_det",
        F_ALIAS_ => "Estado Pendiente / x",
        F_HELP_ => "Estado Pendiente / x",
        F_TYPE_ => "select_list",
        F_OPTIONS_ => "Pendiente,x,%",
        F_NODB_ => "1",
        F_ORD_ => "211",
        F_INLINE_ => "1",
        G_SHOW_ => "64",
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "subform",
        F_OPTIONS_ => "'nro_pedido = '+nro.getVal()+' and estado like '+estado_det.getStr()",
